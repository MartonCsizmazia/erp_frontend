                            ...
                            <table data-vertable="ver6">
                                ...
                                {this.state.products.map(product =>
                                    <tr className="row100" key={product.id}>
                                        ...
                                        <td className="column100 column1" data-column="column1">{product.id}</td>
                                        <td className="column100 column1" data-column="column1">{product.price}</td>
                                        <td className="column100 column1" data-column="column1">{product.profit}</td>
                                        <td className="column100 column1" data-column="column1">{product.manufacturer}</td>
                                    </tr>
                                )}
                                </tbody>
                            </table>
